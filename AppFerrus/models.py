...
class Ordendetrabajo(models.Model):
    ...
    venta_cliente = models.OneToOneField(Venta,on_delete=models.CASCADE, db_column='cliente',  default=0, related_name='Ordendetrabajocliente')
    venta_articulo = models.ForeignKey(Venta, on_delete=models.CASCADE, db_column='articulo',  default=0,  related_name='Ordendetrabajoarticulo')
    empleado_idempleado = models.ForeignKey(Empleado, on_delete=models.CASCADE,  default=0, related_name='Ordendetrabajoventaempleado')
    estado = models.OneToOneField(EstadoOrdentrabajo, on_delete=models.CASCADE,  default=0,  related_name='Ordendetrabajoestado')
class Meta:
