...
var cotizacion1 = {
    ...
    var subtotal = 0.00;
    var mano_de_obra = $('input[name="mano_de_obra"]').val();
    var otrosgastos = $('input[name="otrosgastos"]').val();
        ...
        this.items.precio = this.items.subtotal;
        $('input[name="total"]').val(this.items.precio);
